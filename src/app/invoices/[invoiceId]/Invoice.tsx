...
import { updateStatus,deleteInvoiceAction } from "@/app/action";
        ...
        <div className="flex justify-between mb-8">
            ...
            <DropdownMenu>
                <DropdownMenuTrigger asChild>
                    <Button className="flex items-center gap-2" variant="outline">Change Status 
            ...
            <Dialog>
                ...
                <DialogContent className="bg-white">
                    ...
                    <DialogFooter>
                    <form className="flex" action={deleteInvoiceAction}>
                        <input type="hidden" name="id" value={invoice.id}/> 
